...
$sql = "SELECT setor, patrimonio, ramal, tipo_equipamento, marca, modelo, data_inventario, ultima_checagem, quantidade, observacoes FROM inventario";
...
if ($result->num_rows > 0) {
    ...
    // Cabeçalhos do CSV
    $header = ['Setor', 'Patrimônio', 'ramal (se for telefone)', 'Tipo de Equipamento', 'Marca', 'Modelo', 'Data de Inventário', 'Última Checagem', 'Quantidade', 'Observações'];
