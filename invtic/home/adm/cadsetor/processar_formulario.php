...
$sql = "INSERT INTO setor (nome, nome_responsavel, ramal_setor, localizacao_pai, localizacao_filho) VALUES (?, ?, ?, ?, ?)";
$stmt = $conn->prepare($sql);

// Certifique-se de que o tipo de dados corresponde às suas variáveis
// 's' para strings e 'i' para inteiros
$stmt->bind_param("ssiss", $nome, $nome_responsavel, $ramal_setor, $localizacao_pai, $localizacao_filho );
